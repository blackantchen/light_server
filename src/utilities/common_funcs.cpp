...
static const uint32_t crc32_table[] = { 0x00000000, 0x04C11DB7, 0x09823B6E,
...
uint32_t get_stm32_crc(uint32_t crc, uint8_t *s, uint32_t len) {
	uint8_t byte;
	uint8_t *p = s;
